<template>
    <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
            ...
            <div class="px-3 py-3">
              <h6 class="text-sm text-muted m-0">Tienes <strong class="text-primary">{{count_notifications}}</strong> notificaciones</h6>
            </div>
            {% include "notifications/notifications_dropdown.html" %}
            
            <a href="{% url 'general:notifications_list' %}" class="dropdown-item text-center text-primary font-weight-bold py-3">Ver todas</a>
          </div>
        </li>
    </template>
