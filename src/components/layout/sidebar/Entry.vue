...
<template>
    <NuxtLink :to=entry.path :data-tooltip-target="entry.title.replace(/\s+/g, '-')" data-tooltip-placement="right" class="
        ...
        <img :src='currentTheme === "dark" ? entry.logos.black : entry.logos.white'
