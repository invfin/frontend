...
useSeoMeta({
    title: 'Portfolio',
    ogTitle: 'Portfolio',
    description: 'This is Portfolio, let me tell you all about it.',
    ogDescription: 'This is Portfolio, let me tell you all about it.',
...
<template>
    ...
    <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3 mb-6">
        ...
        <div class="inline-flex rounded-md shadow-sm" role="group">
            <button id="updateProductButton" :data-modal-toggle="assetModal" type="button"
            ...
            <button type="button" :data-modal-toggle="cashModal"
            ...
            <button type="button" :data-modal-toggle="transactionFileModal"
        ...
        <FormsPortfolioStock :modalId="assetModal" modalTitle="Activos" v-model="newMovement" />
        <FormsPortfolioMovement :modalId="cashModal" modalTitle="Movimientos" v-model="newMovement" />
        <FormsPortfolioTransactionsFile :modalId="transactionFileModal" modalTitle="Archivos" v-model="newMovement" />
